...
namespace MaviElmasOtoSis.Araclar
{
    public static class Sifreleme
    {
        ...
        static ICryptoTransform EncryptorTransform;
        static ICryptoTransform DecryptorTransform;

        static void AyarlaKey()
        {
            EncryptorTransform = rm.CreateEncryptor(_Key, _Vector);
            DecryptorTransform = rm.CreateDecryptor(_Key, _Vector);
        }

        static System.Text.UTF8Encoding UTFEncoder = new System.Text.UTF8Encoding();
